    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('product', 'size', 'color'), name='uniq_product_size_color'), models.CheckConstraint(condition=models.Q(('stock_qty__gte', 0)), name='variant_stock_non_negative')],
            },
        ),
    ]
